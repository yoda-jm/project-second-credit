...
const MODELS := "res://games/rocks/art/models/"
...
func _build_environment() -> void:
	...
	bmat.shader = load("res://games/rocks/shaders/backdrop.gdshader")
...
func _material(kind: int) -> Material:
	match kind:
		Kind.DIRT:
			...
			m.shader = load("res://games/rocks/shaders/dirt.gdshader")
			return m
		Kind.DIAMOND:
			var m := ShaderMaterial.new()
			m.shader = load("res://games/rocks/shaders/gem.gdshader")
			return m
