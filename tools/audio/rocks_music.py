...
Usage: python3 tools/audio/rocks_music.py [out_dir]   (default: godot/games/rocks/audio/music)
...
OUT = sys.argv[1] if len(sys.argv) > 1 else "godot/games/rocks/audio/music"
